...
// Koneksi ke db
$connect = mysqli_connect("localhost", "root", "", "medshop");

// Function untuk query
function query($query)
{
    global $connect;
    $result = mysqli_query($connect, $query); // Menjalankan query SQL yang dikirim sebagai parameter
    $rows = []; // Menyiapkan array kosong untuk menampung hasil query
